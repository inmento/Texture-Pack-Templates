# Silver Texture Pack Template

This is an **empty, asset-free template** for a player-created Silver texture
pack. Its game scope is intentionally limited to **Silver**. The template has
...
2. Change the manifest id, name, and description so the pack belongs only to
   you. Do not reuse the template id texture_pack_silver_template for a second installed pack.
