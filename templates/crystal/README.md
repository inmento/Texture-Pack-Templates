# Crystal Texture Pack Template

This is an **empty, asset-free template** for a player-created Crystal texture
pack. Its game scope is intentionally limited to **Crystal**. The template has
...
2. Change the manifest id, name, and description so the pack belongs only to
   you. Do not reuse the template id texture_pack_crystal_template for a second installed pack.
