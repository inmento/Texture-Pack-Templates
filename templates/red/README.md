# Red Texture Pack Template

This is an **empty, asset-free template** for a player-created Red texture
...
2. Change the manifest id, name, and description so the pack belongs only to
   you. Do not reuse the template id texture_pack_red_template for a second installed pack.
